...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/rocksdanister/lively/releases/download/v1.6.0.4/lively_setup_x86_full_v1604.exe'
  softwareName   = 'lively*'
  checksum       = '706f9e7176e1db242b79583aeeedcd3bad199e7d05da29775a678891601c0238'
  checksumType   = 'sha256'
