...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/rocksdanister/lively/releases/download/v1.6.0.2/lively_setup_x86_full_v1602.exe'
  softwareName   = 'lively*'
  checksum       = '112f8c2587d97e57096705336ace649fe3e12e0f25b010bcc3f625a072fb9420'
  checksumType   = 'sha256'
