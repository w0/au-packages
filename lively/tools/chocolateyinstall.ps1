...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/rocksdanister/lively/releases/download/v2.0.3.2/lively_setup_x86_full_v2032.exe'
  softwareName   = 'lively*'
  checksum       = '19286d360fd6197cf4eea6130a93eb28de30a266d58b0f94c4a55662f00732a2'
  checksumType   = 'sha256'
