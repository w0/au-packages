...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/rocksdanister/lively/releases/download/v2.2.0.0/lively_setup_x86_full_v2200.exe'
  softwareName   = 'lively*'
  checksum       = 'd60590c94c3e9fbc141327d82330ac8884e8c73dae6ef1ffeee881cae6c6bc86'
  checksumType   = 'sha256'
