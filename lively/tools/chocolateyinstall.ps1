...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/rocksdanister/lively/releases/download/v2.0.0.0/lively_setup_x86_full_v2000.exe'
  softwareName   = 'lively*'
  checksum       = 'e200208268fa525d1fff753f2d684882443281a6f354e6144e4ab3d337c2ee6d'
  checksumType   = 'sha256'
