...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/rocksdanister/lively/releases/download/v2.0.2.1/lively_setup_x86_full_v2021.exe'
  softwareName   = 'lively*'
  checksum       = '66fea3857d50f9f4dbe2c6df2630d567df283067cb4b90f36c27c3c9cc1d90d4'
  checksumType   = 'sha256'
