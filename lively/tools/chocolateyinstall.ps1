...
$packageArgs = @{
  ...
  fileType       = 'exe'
  url            = 'https://github.com/rocksdanister/lively/releases/download/v2.0.0.1/lively_setup_x86_full_v2001.exe'
  softwareName   = 'lively*'
  checksum       = 'f9ede471f6665a83777ef2f37929fd62d5305105314c9d8c7f25994c9529f210'
  checksumType   = 'sha256'
